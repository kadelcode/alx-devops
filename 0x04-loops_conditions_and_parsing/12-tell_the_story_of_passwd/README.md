...
The file ```/etc/passwd``` has already been covered in a [previous project](https://github.com/kadelcode/alx-devops/tree/main/0x02-shell_redirections) and you should be familiar with it. Today we will make up a story based on it.
